...
# pt_file, ct_file = pairs[gl.pair_index]
# print(gl.pair_index)

# gl.overlaycloseall()

# gl.loadimage(ct_file)
# gl.colorname(0, 'Grayscale')
# gl.minmax(0, -800.0, 150.0)
# gl.opacity(0, 0)

# gl.overlayload(pt_file)
# gl.colorname(1, 'Grayscale')
# gl.invertcolor(1, 1)
# gl.minmax(1, -0.2, 5.0)

# gl.orthoviewmm(2, 150, -200)

# print(f"Showing pair {gl.pair_index+1}/{len(pairs)}:")
# print("  PT:", pt_file)
# print("  CT:", ct_file)

# gl.pair_index = (gl.pair_index + 1) % len(pairs)
